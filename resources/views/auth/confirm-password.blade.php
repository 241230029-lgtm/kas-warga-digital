...
<div class="min-h-[calc(100vh-160px)] flex items-center justify-center py-16 px-4">
    <div class="max-w-md w-full bg-white rounded-[40px] shadow-2xl border border-gray-100 p-10">
        <h1 class="text-4xl font-extrabold text-gray-900 mb-4">Konfirmasi Kata Sandi</h1>
        <p class="text-gray-500 mb-8">Masukkan kata sandi Anda untuk melanjutkan ke area aman.</p>
        ...
        <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
            ...
            <button type="submit" class="w-full bg-emerald-500 text-white rounded-3xl py-4 font-semibold shadow-lg shadow-emerald-200 hover:bg-emerald-600 transition">Konfirmasi Kata Sandi</button>
        </form>
    </div>
</div>
@endsection
